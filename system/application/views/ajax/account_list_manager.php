	...
	$(document).ready(function() {
		...
		var mygrid = jQuery("#list2").jqGrid({ 
			...
			colModel:[ {name:'options',index:'options', width:55, search:false, viewable:false},
					   ...
					   {name:'fname',index:'fname', width:80, hidden:true, editable:true, editrules:{edithidden:true}, viewable:false}, 
					   ...
					   {name:'password',index:'password', width:90, editable:true, search:true}, 						  
					   {name:'role_id',index:'users.role_id', width:90, editable:false, search:true, stype:'select', searchoptions:{sopt:['eq'], value:":---Select---;2:Agent;1:Supervisor"}}, 						  
					   {name:'center_id',index:'center_id', width:120, editable:false, hidden:true, viewable:false, search:false},
					   ...
					   /* {name:'supervisor',index:'supervisor', width:130, editable:false, search:true, 
							searchoptions:{
								dataInit:function(el){																									
									$(el).autocomplete({source:"dashboard/ajaxgetUsers/?track=1"});																																																									
								}
